...
namespace Grapevine.Tests.Server
{
    public class RouterTester
    {
        ...
        //    router.RouterExclusions.Types.Count.ShouldBe(1);
        //    router.RouterExclusions.Types[0].ShouldBe(typeof(RouteTestingHelper));
        //}
        ...
        //{
        //    var router = new Router();
        //    router.RouterExclusions.Types.Count.ShouldBe(0);

        //    router.Exclude<Route>();
        //    router.RouterExclusions.Types.Count.ShouldBe(1);

        //    router.Exclude<Router>();
        //    router.RouterExclusions.Types.Count.ShouldBe(2);
        ...
        //    router.RouterExclusions.NameSpaces.Count.ShouldBe(1);
        //    router.RouterExclusions.NameSpaces[0].ShouldBe(ns);
        //}
        ...
        //{
        //    var router = new Router();
        //    router.RouterExclusions.NameSpaces.Count.ShouldBe(0);

        //    router.ExcludeNameSpace("FakeNamespace");
        //    router.RouterExclusions.NameSpaces.Count.ShouldBe(1);

        //    router.ExcludeNameSpace("NamespaceFake");
        //    router.RouterExclusions.NameSpaces.Count.ShouldBe(2);
